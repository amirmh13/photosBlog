...
<body class="<?php if( get_locale() == 'fa_IR') echo 'persian' ?>">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-md-6 p-0">
            <img src="<?php echo get_template_directory_uri() ?>/images/8.jpg" alt="Images" class="img-fluid">
          </div>
        ...
        <div class="row mb-3">
          <div class="col-md-6 py-3 padding-<?php echo get_locale() ?>" data-aos="fade-up">
            <h3 class="text-black mb-3"><?php _e('What are hand-made tiles?', 'photosBlog') ?></h3>
            <p class="text-justify">
          ...
          <div class="col-md-6 p-0" data-aos="fade-up">
            <img src="<?php echo get_template_directory_uri() ?>/images/9.jpg" alt="Images" class="img-fluid">
          </div>
        </div>

        <div class="row mb-3" data-aos="fade-up">
          <div class="col-md-6 p-0">
            <img src="<?php echo get_template_directory_uri() ?>/images/IMG_9972.jpg" alt="Images" class="img-fluid">
          </div>
    ...
    <div id="products" class="site-section pt-0" data-aos="fade">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 ">
